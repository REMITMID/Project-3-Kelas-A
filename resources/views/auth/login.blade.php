...
<head>
    <meta charset="UTF-8">
    <title>Login - Brawijayan Travel</title>
    ...
    <style>
        ...
        .container-fluid, .left-logo-box, .login-card {
            position: relative;
            z-index: 1;
        }
        .left-logo-box {
        ...
        <div class="row min-vh-100">
            ...
            <div class="col-md-6 d-flex align-items-center justify-content-center">
                <div class="login-card">
                    <h3 class="fw-bold mb-4 text-center">Log in</h3>
                    {{-- Alert error jika ada --}}
                    @if(session('error'))
                        <div class="alert alert-danger">{{ session('error') }}</div>
                    @endif
                    {{-- Bisa juga validasi error --}}
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <button type="submit" class="btn btn-primary w-100 mb-3"
                            style="background:#033C6A; font-weight:600; border-radius: 10px;">Sign in</button>
                    </form>
                    <div class="text-center text-muted" style="margin-bottom:6px; font-size:0.97rem;">Atau Log in dengan
                    </div>
                    ...
                    <div class="login-link">
                        Belum punya akun? <a href="{{ url('/register') }}"><b>daftar di sini</b></a>
                    </div>
                </div>
            </div>
        </div>
